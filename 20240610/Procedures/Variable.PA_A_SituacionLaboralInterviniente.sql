...
-- Description:					<Traducción de las Variable del PJEditor relacionadas con la Situación laboral del intervinientes para LibreOffice>
-- ====================================================================================================================================================================================
-- Modidicación:				<19/01/2022> <Aida Elena Siles R> <Se agrega lógica para legajos.>
-- ====================================================================================================================================================================================
CREATE PROCEDURE [Variable].[PA_A_SituacionLaboralInterviniente]
...
SELECT	RTRIM(LTRIM(Value))
	...
	BEGIN
		SELECT		E.TC_Descripcion							AS Escolaridad
		...
		AND			A.TN_CodEscolaridad							IS NOT NULL
		...
		INNER JOIN	Catalogo.SituacionLaboral					E WITH(NOLOCK)
		ON			A.TN_CodSituacionLaboral					= E.TN_CodSituacionLaboral
