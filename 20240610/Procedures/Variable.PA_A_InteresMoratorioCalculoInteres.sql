...
-- Description:					<Traducción de la Variable del PJEditor A_InteresMoratorio para LibreOffice>
-- ====================================================================================================================================================================================
CREATE PROCEDURE [Variable].[PA_A_InteresMoratorioCalculoInteres]                 
...
BEGIN
	...
	SELECT		Top(1) A.TN_InteresMoratorio				As Interes
