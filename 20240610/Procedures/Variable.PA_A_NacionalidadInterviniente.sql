...
-- Description:					<Traducción de las Variable del PJEditor relacionadas con la nacionalidad de las partes para LibreOffice>
-- ====================================================================================================================================================================================
-- Modidicación:				<18/01/2022> <Aida Elena Siles R> <Se agrega lógica para legajos.>
-- ====================================================================================================================================================================================
CREATE PROCEDURE [Variable].[PA_A_NacionalidadInterviniente]
...
SELECT	RTRIM(LTRIM(Value))
	...
	BEGIN
		SELECT		E.TC_Descripcion							AS Nacionalidad
		...
		INNER JOIN	Catalogo.Pais								E WITH(NOLOCK)
