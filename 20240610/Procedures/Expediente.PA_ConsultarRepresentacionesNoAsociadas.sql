...
-- Descripción :			<Permite consultar las representaciones no asociadas
-- =================================================================================================================================================
-- Modificación:			<15/09/2020><Daniel Ruiz Hernandez><Consultar representaciones de legajos.>
...
-- =================================================================================================================================================
CREATE PROCEDURE [Expediente].[PA_ConsultarRepresentacionesNoAsociadas]
...
Begin
	...
	if (@L_CodigoLegajo is null)
		Select 			X.TB_Principal					As Principal,					X.TB_NotificaRepresentante		As NotificaRepresentante,
						...
						'Split'							As	Split,
						X.TU_CodInterviniente			As CodInterviniente,		    Z.TU_CodInterviniente			As CodIntervinienteRepresentante,		
		...
		On				X.TU_CodIntervinienteRepresentante	=	Z.TU_CodInterviniente 
		AND				X.TU_CodInterviniente=	ISNULL(@L_CodigoInterviniente, X.TU_CodInterviniente)
		...
		Where			
						Z.TC_TipoParticipacion		    =   @L_TipoParticipacion
		...
		ON				Q.TU_CodInterviniente			= Z.TU_CodInterviniente 
		left Join		Expediente.Interviniente		As	A With(NoLock)
		On 				A.TU_CodInterviniente			=	Z.TU_CodInterviniente
		left outer Join	Expediente.Representacion		As 	X WITH(NoLock)
		On				X.TU_CodIntervinienteRepresentante	=	Z.TU_CodInterviniente 
