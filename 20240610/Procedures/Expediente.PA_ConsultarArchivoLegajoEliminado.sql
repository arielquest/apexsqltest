...
GO
-- =======================================================================
-- Autor:		   <Mario Camacho Flore>
-- Fecha Creación: <24/05/2022>
-- Descripcion:	   <Consulta de archivos por legajo borrados lógicamente>
-- Devuelve lista de archivos por legajo que están borrados lógicamente
-- ========================================================================
CREATE PROCEDURE [Expediente].[PA_ConsultarArchivoLegajoEliminado] 
	@CodLegajo				char(40)
AS
BEGIN
			...
			ON		   	AE.TC_NumeroExpediente			= EL.TC_NumeroExpediente
			...
			INNER JOIN	Expediente.LegajoArchivo   		H WITH(NOLOCK)
			ON			H.TU_CodArchivo					= A.TU_CodArchivo

			WHERE		EL.TU_CodLegajo					= @CodLegajo
