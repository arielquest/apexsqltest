...
-- Descripción :			<Valida si una solicitud puede ser itinerada>  
-- =================================================================================================================================================

CREATE PROCEDURE [Itineracion].[PA_ValidarEnvioSolicitud]
...
BEGIN 
	...
	IF (@L_ConsultarDetalle = 0)
		...
		FROM	Expediente.IntervencionSolicitud		A WITH(NOLOCK)
		...
		ELSE			
			...
			SELECT		@L_SinDocumentoAsociado			= A.TU_CodArchivo
