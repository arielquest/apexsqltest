...
-- Fecha de creación:		<04/02/2019>
-- Descripción :			<Permite consultar los estados de representación de la defensa> 
-- =================================================================================================================================================
CREATE PROCEDURE [Catalogo].[PA_ConsultarEstadoRepresentacion]
 ...
 Begin  
   DECLARE @ExpresionLike varchar(152)
	...
	Begin
			Select		A.TN_CodEstadoRepresentacion		As	Codigo,				
						A.TC_Descripcion					As	Descripcion,
						A.TF_Inicio_Vigencia				As	FechaActivacion,
						A.TF_Fin_Vigencia					As	FechaDesactivacion,
						'split'								As	Split,
						A.TC_Circulante						As	Circulante,						
						A.TC_Pasivo							As	CirculantePasivo
			From		Catalogo.EstadoRepresentacion		A	With(Nolock)
			Where		dbo.FN_RemoverTildes(A.TC_Descripcion) like dbo.FN_RemoverTildes(@ExpresionLike)
			And			A.TN_CodEstadoRepresentacion		=	Coalesce(@Codigo, A.TN_CodEstadoRepresentacion)
