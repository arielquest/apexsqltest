...
-- Description:					<Traducción de las Variable del PJEditor relacionadas con la fecha de nacimiento de las partes para LibreOffice>
-- ====================================================================================================================================================================================
-- Modificación:				<21/06/2021> <Isaac Santiago Méndez Castillo> <Se modifica el SELECT para que únicamente se obtenga la fecha de nacimiento en el 
--																			   siguiente formato "dd/mm/yyyy">
-- ====================================================================================================================================================================================
-- Modificación:				<17/01/2022> <Aida Elena Siles R> <Se agrega lógica para legajos.>
-- ====================================================================================================================================================================================
CREATE PROCEDURE [Variable].[PA_A_FechaNacimientoInterviniente]
...
BEGIN
	...
	BEGIN
		SELECT		CONVERT(VARCHAR, D.TF_FechaNacimiento, 103)			AS FechaNacimiento
