...
-- Description:					<Traducción de la Variable del PJEditor relacionadas con la fecha de boleta de transito para LibreOffice>
-- ====================================================================================================================================================================================
CREATE PROCEDURE [Variable].[PA_A_FechaBoletaTransito]                 
...
BEGIN
	...
	Select		C.TF_FechaBoleta							As Fecha
