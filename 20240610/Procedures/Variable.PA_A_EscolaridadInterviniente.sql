...
-- Description:					<Traducción de las Variable del PJEditor relacionadas con la escolaridad de las partes para LibreOffice>
-- ====================================================================================================================================================================================
-- Modificación:				<Aida Elena Siles R> <14/01/2022> <Se agrega lógica para legajos.>
-- ====================================================================================================================================================================================
CREATE PROCEDURE [Variable].[PA_A_EscolaridadInterviniente]
...
SELECT	RTRIM(LTRIM(Value))
	...
	BEGIN
		...
		INNER JOIN	Catalogo.Escolaridad						E WITH(NOLOCK)
		ON			A.TN_CodEscolaridad							= E.TN_CodEscolaridad
