...
-- Descripción:			<Permite consultar un registro en la tabla: Fotografia.>
-- ==================================================================================================================================================================================
CREATE PROCEDURE	[Objeto].[PA_ConsultarFotografia]
...
BEGIN
	...
	FROM	Archivo.Archivo				A WITH (NOLOCK)				INNER JOIN
			Objeto.Fotografia			B WITH (NOLOCK)
