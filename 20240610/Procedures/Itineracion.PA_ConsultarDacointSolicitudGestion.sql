...
-- Descripción :			<Permite consultar los registros de DACOINT que vienen relacionados a una solicitud de una itineración>
-- =============================================================================================================================================================================
...
-- =============================================================================================================================================================================
 CREATE PROCEDURE [Itineracion].[PA_ConsultarDacointSolicitudGestion]
...
BEGIN
	...
	WITH DACOINT AS (
	 SELECT         X.Y.value('(IDACO)[1]',			'INT')		IDACO,	
		...
		FROM @L_XML.nodes('(/*/DACOSOL)') AS A(B)
	)
