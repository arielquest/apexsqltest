...
-- Description:					<Traducción de las Variable del PJEditor relacionadas con el lugar de nacimiento de las partes para LibreOffice>
-- ====================================================================================================================================================================================
-- Modificación:				<18/01/2022> <Aida Elena Siles R> <Se agrega lógica para legajos.>
-- ====================================================================================================================================================================================
CREATE PROCEDURE [Variable].[PA_A_LugarNacimientoInterviniente]
...
SELECT	RTRIM(LTRIM(Value))
	...
	BEGIN
		SELECT		D.TC_LugarNacimiento			AS LugarNacimiento
		...
		AND			D.TC_LugarNacimiento			IS NOT NULL
		AND			(
