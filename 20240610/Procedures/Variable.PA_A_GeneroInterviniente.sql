...
-- Description:					<Traducción de las Variable del PJEditor relacionadas con el genero de las partes para LibreOffice>
-- ====================================================================================================================================================================================
-- Modificación:				<17/01/2022> <Aida Elena Siles R> <Se agrega lógica para legajos.>
-- ====================================================================================================================================================================================
CREATE PROCEDURE [Variable].[PA_A_GeneroInterviniente]
...
SELECT	RTRIM(LTRIM(Value))
	...
	BEGIN
		SELECT		E.TC_Descripcion				AS Genero
		...
		INNER JOIN	Catalogo.Sexo					E WITH(NOLOCK)
		ON			D.TC_CodSexo					= E.TC_CodSexo
