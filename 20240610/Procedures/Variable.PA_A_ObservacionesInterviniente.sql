...
-- Description:					<Traducción de la Variable del PJEditor relacionadas con las observaciones de las partes para LibreOffice>
-- ====================================================================================================================================================================================
-- Modidicación:				<18/01/2022> <Aida Elena Siles R> <Se agrega lógica para legajos.>
-- ====================================================================================================================================================================================
CREATE PROCEDURE [Variable].[PA_A_ObservacionesInterviniente]
...
SELECT	RTRIM(LTRIM(Value))
	...
	BEGIN
		SELECT		A.TC_Caracteristicas			AS Observaciones
		...
		AND			A.TC_Caracteristicas			IS NOT NULL
