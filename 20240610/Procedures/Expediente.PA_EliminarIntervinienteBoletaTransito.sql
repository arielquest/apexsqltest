...
-- =================================================================================================================================================
CREATE PROCEDURE [Expediente].[PA_EliminarIntervinienteBoletaTransito]
...
Begin
	...
	Begin Try 
		Begin Tran
			...
			Delete Expediente.IntervinienteBoletaTransito Where TU_CodInterviniente= @CodInterviniente;	
