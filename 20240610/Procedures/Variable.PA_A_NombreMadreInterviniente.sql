...
-- Description:					<Traducción de las Variable del PJEditor relacionadas con el nombre de la madre de las partes para LibreOffice>
-- ====================================================================================================================================================================================
-- Modificación:				<18/01/2022> <Aida Elena Siles R> <Se agrega lógica para legajos.>			
-- ====================================================================================================================================================================================
CREATE PROCEDURE [Variable].[PA_A_NombreMadreInterviniente]
...
SELECT	RTRIM(LTRIM(Value))
	...
	BEGIN
		SELECT		D.TC_NombreMadre				AS NombreMadre
		...
		AND			D.TC_NombreMadre				IS NOT NULL
		AND			(
