...
-- ==================================================================================================================================================================================  
CREATE PROCEDURE [Catalogo].[PA_AgregarHorarioCitaHabilitado] 
...
BEGIN  
 ...
 --Lógica  
 INSERT INTO Catalogo.HorarioCitaHabilitado VALUES(NEWID() ,@L_CodConfiguracion, @L_HoraInicio,@L_HabilitaLunes,@L_HabilitaMartes,@L_HabilitaMiercoles,@L_HabilitaJueves,@L_HabilitaViernes, @L_HabilitaSabado, @L_HabilitaDomingo, GETDATE())
