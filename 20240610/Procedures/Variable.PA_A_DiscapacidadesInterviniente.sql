...
-- Description:					<Traducción de la Variable del PJEditor relacionadas con las discapacidades de las partes para LibreOffice>
-- ====================================================================================================================================================================================
...
-- ====================================================================================================================================================================================
CREATE PROCEDURE [Variable].[PA_A_DiscapacidadesInterviniente]
...
SELECT	RTRIM(LTRIM(Value))
	...
	BEGIN
		SELECT STUFF((SELECT		', ' + Discapacidades
		FROM		(
						SELECT		G.TC_Descripcion						AS Discapacidades
						...
						INNER JOIN	Expediente.IntervinienteDiscapacidad	F With(NoLock)
						On			A.TU_CodInterviniente					= F.TU_CodInterviniente
						INNER JOIN	Catalogo.Discapacidad					G With(NoLock)
						ON			F.TN_CodDiscapacidad					= G.TN_CodDiscapacidad
		...
		AS			TABLA
		WHERE		Discapacidades IS NOT NULL
		ORDER BY	Discapacidades Desc
		FOR XML PATH ('')), 1, 2, '')
	END
	ELSE
	BEGIN
