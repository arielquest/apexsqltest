...
-- Descripción:			<Permite consultar un registro en la tabla: SolicitudTransferencia.>
-- ==================================================================================================================================================================================
CREATE PROCEDURE	[Objeto].[PA_ConsultarSolicitudTransferencia]
...
BEGIN
	...
	--Lógica
	SELECT		A.TU_CodSolicitudTransferencia					AS	Codigo,
	...
	FROM		Objeto.SolicitudTransferencia					AS	A WITH(NOLOCK)
	...
	AND			A.TU_CodSolicitudTransferencia					= Coalesce(@L_TU_CodSolicitudTransferencia, A.TU_CodSolicitudTransferencia)
END
GO
