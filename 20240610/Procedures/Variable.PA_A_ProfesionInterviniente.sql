...
-- Description:					<Traducción de lAS Variable del PJEditor relacionadAS con la profesion de lAS partes para LibreOffice>
-- ====================================================================================================================================================================================
-- Modidicación:				<19/01/2022> <Aida Elena Siles R> <Se agrega lógica para legajos.>
-- ====================================================================================================================================================================================
CREATE PROCEDURE [Variable].[PA_A_ProfesionInterviniente]
...
SELECT	RTRIM(LTRIM(Value))
	...
	BEGIN
		SELECT		E.TC_Descripcion							AS Profesion
		...
		AND			A.TN_CodProfesion							IS NOT NULL
		...
		INNER JOIN	Catalogo.Profesion							E WITH(NOLOCK)
		ON			A.TN_CodProfesion							= E.TN_CodProfesion
